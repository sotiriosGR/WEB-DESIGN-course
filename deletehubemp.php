...
include('connection.php');
      ...
      $delusername = $_POST['delhubuser'];
      $accepted=0;

      $enaquery = "SELECT * FROM hubemployees WHERE username='$delusername'";
      ...
      while($skata=mysqli_fetch_assoc($enaresult)){
        if($delusername=$skata['username']){
          ...
          $accepted=$accepted+1;
          $delshempquery = "DELETE FROM hubemployees WHERE username='$delusername'";
